...
_STARTMODE = _descriptor.EnumDescriptor(
  name='StartMode',
  full_name='firebird.saturnin.service.node.StartMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_REPLYINSTALLEDSERVICES = _descriptor.Descriptor(
  ...
  full_name='firebird.saturnin.service.node.ReplyInstalledServices',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='services', full_name='firebird.saturnin.service.node.ReplyInstalledServices.services', index=0,
...
_RUNNINGSERVICE = _descriptor.Descriptor(
  name='RunningService',
  full_name='firebird.saturnin.service.node.RunningService',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='peer', full_name='firebird.saturnin.service.node.RunningService.peer', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='agent', full_name='firebird.saturnin.service.node.RunningService.agent', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mode', full_name='firebird.saturnin.service.node.RunningService.mode', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='endpoints', full_name='firebird.saturnin.service.node.RunningService.endpoints', index=3,
...
_REPLYRUNNINGSERVICES = _descriptor.Descriptor(
  ...
  full_name='firebird.saturnin.service.node.ReplyRunningServices',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='services', full_name='firebird.saturnin.service.node.ReplyRunningServices.services', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUESTINTERFACEPROVIDERS = _descriptor.Descriptor(
  ...
  full_name='firebird.saturnin.service.node.RequestInterfaceProviders',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='interface_uid', full_name='firebird.saturnin.service.node.RequestInterfaceProviders.interface_uid', index=0,
...
_REPLYINTERFACEPROVIDERS = _descriptor.Descriptor(
  ...
  full_name='firebird.saturnin.service.node.ReplyInterfaceProviders',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_REQUESTSTARTSERVICE = _descriptor.Descriptor(
  ...
  full_name='firebird.saturnin.service.node.RequestStartService',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='agent_uid', full_name='firebird.saturnin.service.node.RequestStartService.agent_uid', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mode', full_name='firebird.saturnin.service.node.RequestStartService.mode', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='endpoints', full_name='firebird.saturnin.service.node.RequestStartService.endpoints', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeout', full_name='firebird.saturnin.service.node.RequestStartService.timeout', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multiinstance', full_name='firebird.saturnin.service.node.RequestStartService.multiinstance', index=4,
...
_REPLYSTARTSERVICE = _descriptor.Descriptor(
  ...
  full_name='firebird.saturnin.service.node.ReplyStartService',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='peer_uid', full_name='firebird.saturnin.service.node.ReplyStartService.peer_uid', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mode', full_name='firebird.saturnin.service.node.ReplyStartService.mode', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='endpoints', full_name='firebird.saturnin.service.node.ReplyStartService.endpoints', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ReplyInstalledServices = _reflection.GeneratedProtocolMessageType('ReplyInstalledServices', (_message.Message,), dict(
  ...
  __module__ = 'node_pb2'
  # @@protoc_insertion_point(class_scope:firebird.saturnin.service.node.ReplyInstalledServices)
  ))
...
RunningService = _reflection.GeneratedProtocolMessageType('RunningService', (_message.Message,), dict(
  ...
  __module__ = 'node_pb2'
  # @@protoc_insertion_point(class_scope:firebird.saturnin.service.node.RunningService)
  ))
...
ReplyRunningServices = _reflection.GeneratedProtocolMessageType('ReplyRunningServices', (_message.Message,), dict(
  ...
  __module__ = 'node_pb2'
  # @@protoc_insertion_point(class_scope:firebird.saturnin.service.node.ReplyRunningServices)
  ))
...
RequestInterfaceProviders = _reflection.GeneratedProtocolMessageType('RequestInterfaceProviders', (_message.Message,), dict(
  ...
  __module__ = 'node_pb2'
  # @@protoc_insertion_point(class_scope:firebird.saturnin.service.node.RequestInterfaceProviders)
  ))
...
ReplyInterfaceProviders = _reflection.GeneratedProtocolMessageType('ReplyInterfaceProviders', (_message.Message,), dict(
  ...
  __module__ = 'node_pb2'
  # @@protoc_insertion_point(class_scope:firebird.saturnin.service.node.ReplyInterfaceProviders)
  ))
...
RequestStartService = _reflection.GeneratedProtocolMessageType('RequestStartService', (_message.Message,), dict(
  ...
  __module__ = 'node_pb2'
  # @@protoc_insertion_point(class_scope:firebird.saturnin.service.node.RequestStartService)
  ))
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\032org.firebird.saturnin.nodeB\021SaturninNodeProtoP\001\242\002\007SNodePB\252\002\025Saturnin.Service.Node'))
